...
CREATE TABLE authorization.authority_definitions (
...
CREATE TABLE authorization.purpose_definitions (
...
CREATE TABLE authorization.authority_grants (
    ...
    authority_definition_id uuid NOT NULL REFERENCES authorization.authority_definitions(authority_definition_id),
...
CREATE TABLE authorization.incompatible_authority_sets (
...
CREATE TABLE authorization.incompatible_authority_members (
    incompatible_authority_set_id uuid NOT NULL REFERENCES authorization.incompatible_authority_sets(incompatible_authority_set_id),
    authority_definition_id uuid NOT NULL REFERENCES authorization.authority_definitions(authority_definition_id),
